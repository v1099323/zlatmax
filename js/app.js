(() => {
        ...
        !(function (e) {
          ...
          function ae(t, s, o) {
            ...
            function Te(e, t, s, n, i) {
              return (
                i || (t = ye(P, e, t, s, n, !1)), !1 !== t && (Ce(e, t), !0)
              );
            }
            function Oe(e) {
              if (S[e]) {
  ...
  (() => {
    ...
    function O(e) {
      return x(T(e)).left + C(e).scrollLeft;
    }
    function A(e) {
    ...
    function N(e) {
      for (var t = m(e), s = I(e); s && D(s) && "static" === A(s).position; )
        s = I(s);
      return s &&
        ("html" === E(s) || ("body" === E(s) && "static" === A(s).position))
        ? t
        : s ||
            (function (e) {
              var t =
              ...
              if (
                ...
                return null;
              for (var s = M(e); v(s) && ["html", "body"].indexOf(E(s)) < 0; ) {
                var n = A(s);
                if (
                  "none" !== n.transform ||
                  "none" !== n.perspective ||
    ...
    function oe(e) {
      ...
      if (c) {
        ...
        if (
          ...
          (x = q),
            (v -=
              (u && C.visualViewport ? C.visualViewport.height : E[O]) -
              n.height),
            (v *= l ? 1 : -1);
        if (i === j || ((i === V || i === q) && r === F))
          (w = B),
            (f -=
              (u && C.visualViewport ? C.visualViewport.width : E[L]) -
              n.width),
            (f *= l ? 1 : -1);
      }
      var P,
    ...
    window.addEventListener("load", function (e) {
      !(function () {
        if ((Es(), document.querySelector(".thumbs-images"))) {
    ...
    const As = document.querySelectorAll(".sub-menu-catalog__block");
    As.length &&
      As.forEach((e) => {
